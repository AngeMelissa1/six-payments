...
<div>
    ...
    <div class="grid-container">
        ...
        <div class="grid-item">
            <img src="images/Vit.JPG" alt="Product 1">
            <p>Vitamins</p>
            <div class="actions">
        ...
        <div class="grid-item">
            <img src="images/bike.jpg" alt="Product 2">
            <p>Exercise Bikes</p>
            <div class="actions">
        ...
        <div class="grid-item">
            <img src="images/yoga.jpg" alt="Product 3">
            <p>Yoga Mats</p>
            <div class="actions">
        ...
        <div class="grid-item">
            <img src="images/face.jpg" alt="Product 4">
            <p>Face masks</p>
            <div class="actions">
        ...
        <div class="grid-item">
            <img src="images/Protein.jpg" alt="Product 5">
            <p>Proteins</p>
            <div class="actions">
        ...
        <div class="grid-item">
            <img src="images/Thermometer.jpg" alt="Product 6">
            <p>Clinical Thermometer</p>
            <div class="actions">
